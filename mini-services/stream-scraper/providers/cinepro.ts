/**
 * CinePro (OMSS) multi-provider resolver — source fan-out + edge proxy.
...
/** Keep more provider streams per title (multi-server list). */
...
function friendlyLabel(
  ...
  // names for CinePro's 14 providers (enc-dec Lordflix API is dead).
