...
export function sortSourcesForDefault<T extends RankableSource>(
  ...
  return [...sources].sort((a, b) => {
    ...
    // Known height within the same tier (4K > 1080, 720 > 480) before probe
    // health. Auto clients send qualityHint=1080, so a hint-gated 4K
    // preference never fired and unprobed 4K lost to probe.ok HD.
